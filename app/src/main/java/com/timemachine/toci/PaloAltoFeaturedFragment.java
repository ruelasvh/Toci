 ...
 */
public class PaloAltoFeaturedFragment extends Fragment {

    private static final String ARG_SECTION_TITLE = "PaloAltoFeaturedFragment";

    private static final String ARG_SECTION_CITY = "Palo Alto";
    ...
    public PaloAltoFeaturedFragment() {
        // Required empty public constructor
    }

    public static PaloAltoFeaturedFragment newInstance() {
        PaloAltoFeaturedFragment fragment = new PaloAltoFeaturedFragment();
