 ...
 */
public class MountainViewFeaturedFragment extends Fragment {

    private static final String ARG_SECTION_TITLE = "MountainViewFeaturedFragment";

    private static final String ARG_SECTION_CITY = "Mountain View";
    ...
    public MountainViewFeaturedFragment() {
        // Required empty public constructor
    }

    public static MountainViewFeaturedFragment newInstance() {
        MountainViewFeaturedFragment fragment = new MountainViewFeaturedFragment();
